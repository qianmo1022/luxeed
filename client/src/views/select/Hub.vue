<template>
    <preview>
      ...
      <template v-slot:info>
        <div class="title text-[16px] font-bold">19英寸空气动力学轮毂</div>
      ...
      <template v-slot:choose>
        <div class="color-list flex justify-center items-center mt-4 ml-4 mr-4">
          <div class="color-box w-[60px] h-[60px] flex justify-center items-center">
            <div class="color-item w-4 h-4 rounded-full ">
                <img src="https://res2.vmallres.com/pimages/uomcdn/CN/pms/202311/attribute/99724/0D89F0BCCA7FAFEB6B8329F15BFD8916.png">
            </div>
          </div>
        </div>
      </template>
      ...
      <sumPrice>
          ...
          <router-link to="/select/seat">下一步</router-link>
          </template>
      </sumPrice>
  </template>
